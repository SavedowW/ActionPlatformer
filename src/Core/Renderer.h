...
public:
    ...
    void renderTexture(SDL_Texture* tex_, int x_, int y_, int w_, int h_, const Camera &cam_, float angle_, const Vector2<int> &center_, SDL_RendererFlip flip_);
    void renderTexture(SDL_Texture* tex_, int x_, int y_, int w_, int h_, const Camera &cam_, float angle_, SDL_RendererFlip flip_);
    ...
    void renderTexture(SDL_Texture* tex_, int x_, int y_, int w_, int h_, const SDL_Rect &src, const Camera &cam_, SDL_RendererFlip flip_);
